...
const targetLeagues = [
  ...
  '欧足联', '英冠', '英足总杯', 'CBA', 'WCBA', 'WCBA杯', '国际赛', '中超','中NBL',
  '欧篮联', '世亚预', '美冠杯', '沙特超', '超级杯', '女亚洲杯', '女亚杯预', '美职联',
  '日职联', '韩K联', '亚精英赛', '亚冠二级', '女篮世界杯', '世界杯', 'WNBA', '中甲'];
      ...
      if (count > 0) {
        ...
        for (let i = 0; i < Math.min(count, 3); i++) {
          nodes.push({
            ...
            url: [`https://miguvideo.957.de5.net/api/player?flag=88看球回放&pid=${match.mgdbId}_${i}`]
          });
        }
      } else {
        continue; // 没有回放，跳过该比赛
